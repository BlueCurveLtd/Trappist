...
internal static class NavigationItemContainer
{
    ...
    /// <exception cref="NavigationRegistrationException">The view alias cannot be empty or white spaces.</exception>
    /// <exception cref="ViewAliasAlreadyExistsException">A view with the alias '{alias}' already exists.</exception>

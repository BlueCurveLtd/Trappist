...
public class InvokeCommandAction : TriggerAction<UIElement>
{
    ...
    /// </summary>
    public void InvokeAction(object parameter) => this.Invoke(parameter);
    ...
    private ExecutableCommandBehavior? GetOrCreateBehavior()
    {
        ...
        if (this.commandBehavior is null && this.AssociatedObject is not null)
        {
    ...
    private class ExecutableCommandBehavior : CommandBehaviorBase<UIElement>
    {
        ...
        public ExecutableCommandBehavior([DisallowNull] UIElement target)
            : base(target)
        {
        }

...
public partial class MasterDetail : Window
{
    ...
    {
        Source = new Uri("/Trappist.Wpf.Bedrock.Themes;component/BasicBedrockTheme.xaml", UriKind.RelativeOrAbsolute)
    };

    private static readonly ResourceDictionary MasterResourceDictionary = new ResourceDictionary
    {
        Source = new Uri("/Trappist.Wpf.Bedrock.Controls;component/Pages/MasterDetailTheme.xaml", UriKind.RelativeOrAbsolute)
    };

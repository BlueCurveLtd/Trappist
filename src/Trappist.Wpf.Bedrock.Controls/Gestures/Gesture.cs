...
/// <summary>
/// Recognizable gestures. Has <see cref="FlagsAttribute">FlagsAttribute</see> to allow combinations
/// of values (e.g. <code>Gesture.SwipeUp | Gesture.SwipeDown</code>).
/// Recognized gestures will be affected by <see cref="GestureModifier"/>.
/// </summary>
[Flags]
